...
<div class="col-sm-6 mt-5 mx-3">
    ...
    <?php
            ...
            {
                // query chlae gae or table rhae ga
                $sql= "SELECT * FROM assignwork_db WHERE request_id={$_REQUEST['id']}";
                $result = $conn->query($sql);
                $row = $result->fetch_assoc(); ?>
    <!-- // ake sae query run ho rha hai or dosrae sae data fetch ho rha hai -->
    <!-- // ake table bna dena hia or row kae through data retrieve krwa dena hai -->
