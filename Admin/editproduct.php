...
if(isset($_REQUEST['pupdate']))
{
    ...
    || ($_REQUEST['ptotal'] == "") || ($_REQUEST['poriginalcost'] == "") || ($_REQUEST['psellingcost'] == ""))
    {
        ...
        // sari values jo hain un ko catch krna ho ga
        $pid = $_REQUEST['pid'];
        ...
        if($conn->query($sql) == TRUE){
            $msg = '<div class="alert alert-success col-sm-6 mt-2 ml-5">Updated Successfully</div>';
        }
        else{
            $msg = '<div class="alert alert-danger col-sm-6 mt-2 ml-5">Unable to update</div>';
        }
    }
}
...
?>
<!-- pehale form bnatae hain phr retreieve krwatae hain -->
<!-- 2nd column start -->
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="poriginalcost" name="poriginalcost"
                onkeypress="isInputNumber(event)" value="<?php if(isset($row['poriginalcost'])) {echo $row['poriginalcost'];}?>">
        </div>
        <div class="form-group">
        ...
        <div class="text-center">
            <button type="submit" class="btn btn-danger" name="pupdate" id="pupdate">Update</button>
