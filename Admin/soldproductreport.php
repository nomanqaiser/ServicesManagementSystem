...
<!-- // start 2nd column -->
<!-- ake form bane ga 2 date ko form bnae gae, or search ka button ho ga -->
<div class="col-sm-9 col-md-10 mt-5 text-center">
    <form action="" method="POST" class="d-print-none">
        <div class="form-row">
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-secondary" name="searchsubmit" value="submit">
            </div>
        </div>
    </form>
    ...
    <?php
        if(isset($_REQUEST['searchsubmit']))
            {
                // pehlae hum nae date lae lna hai varible bna laatae hain
