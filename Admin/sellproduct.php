...
if(isset($_REQUEST['psubmit'])){
    ...
    else
    {
        ...
        {
            // ab cuitomer bioll kae stah print tou krna ho ga,new page ame rwedirect kr skae data kae sath
            // jo customer id generate ho rha hai, uc ko session mae rakh lena hai
            $genid = mysqli_insert_id($conn);
            session_start();
            // ab ic ko session varaiable ame rakhae gae
            $_SESSION['myid'] = $genid;
