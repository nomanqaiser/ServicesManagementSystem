    ...
    <?php
        ...
        if($result->num_rows > 0)
        {
            ...
            while($row = $result->fetch_assoc()){
                ...
                echo '<td>';
                // view buuton
                // ab view kae button pae click hotae hi, o be id hai wo pass hona chyie, khan per edit wale page per
                ...
                echo '<input type="hidden" name="id" value='.$row['request_id'].'>
                <button class="btn btn-secondary" name="delete" value="Delete" type="submit">
        ...
        // agr koi data nhe hai....
        else
        {
            echo 'Zero Result';
        }
        // dekete ka code icon wala
        if(isset($_REQUEST['delete']))
        {
        $sql = "DELETE FROM assignwork_db WHERE request_id = {$_REQUEST['id']}";
